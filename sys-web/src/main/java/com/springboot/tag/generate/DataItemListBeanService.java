 ...
 */
@Component
public class DataItemListBeanService extends AbstractLabelService {
    ...
    public Object getObject(JSONObject paramObj) {
        ...
        if(parentEOs == null){
            parentEOs = new ArrayList<DataItemEO>();
        }
        for(DataItemEO dataItemEO:parentEOs){
            ...
            if(childEOs == null){
                childEOs = new ArrayList<DataItemEO>();
            }
            ...
            if(hasData){
                Map<String,Object> childItemMap = new HashMap<String, Object>();
